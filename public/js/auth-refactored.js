...
import { login as apiLogin, register as apiRegister, getCurrentUser, logout as apiLogout } from './api.js?v=20260409';
import { showLoadingModal, showSuccessModal, showErrorModal, closeModal } from './modal.js';
import { initAuthStatus, updateAuthStatus } from './auth-status.js?v=20260409';
