import { getCurrentUser, searchArtists, createArtist, uploadCover, uploadArtistImage, addReview, getTrack, resolveAvatarUrl } from './api.js?v=20260421';
...
function initForm() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      const { createTrack } = await import('./api.js?v=20260421');
